...
<head>
    ...
    <link rel="stylesheet" href="CSS/produc15.css">
...
<body>
    ...
    <?php
        ...
        ?>
    <form class="FormIzquierda" action="carpeta.php?nombrecomp=<?php echo $_GET['nombrecomp']; ?>" method="POST" enctype=“multipart/form-data”>
        ...
        <br>
        <label for="" class="escribir"><b>Escribir nombre completo y correcto</b></label>
        <br>
        <label for="" class="advertencia"><b>Advertencia: </b>Una vez escrito no se podrá modificar</label>
        <br>
        <!--<img src="IMG/Aviso.PNG" alt="" class="aviso">-->
        <br>
        <br>
        <input type="text" value="" name="carpeta" class="lotex" placeholder="Ingresar el nombre de a quién se va a facturar">
        <input class="Blog2"   type="submit"  value="Agregar Nombre">
    </form>
...
<div id="openModal2" class="modalDialog2">
 ...
 <img src="IMG/logo.jpg" class="GF" alt="">
