...
<head>
    ...
    <title>REVISANDO ARCHIVO</title>

    <link rel="stylesheet" href="CSS/quevo7.css">
...
?>
 <div class="paneles"  onClick="pausaplay()">
    <form class="p1" value="archivos" name="otra"     method="POST" id="removeme" action="upload2.php?idcarpeta=<?php echo $_GET['nombre']; ?>&idcarpeta=<?php echo $_GET["idcarpeta"];?>&nombre2=<?php echo $nombre2; ?>" enctype="multipart/form-data"  >
      <label for="" class="lb1">Factura XML</label>
        ...
        <form class="p2"   value="archivos" name="otra"     method="POST" id="removeme" action="upload3.php?idcarpeta=<?php echo $_GET['nombre']; ?>&idcarpeta=<?php echo $_GET["idcarpeta"];?>&nombre2=<?php echo $nombre2; ?>"enctype="multipart/form-data">
        ...
        <form class="p3" value="archivos" name="otra"     method="POST" id="removeme"  action="upload4.php?idcarpeta=<?php echo $_GET['nombre']; ?>&idcarpeta=<?php echo $_GET["idcarpeta"];?>&nombre2=<?php echo $nombre2; ?>" enctype="multipart/form-data">
        ...
        <form class="p4" value="archivos" name="otra"     method="POST" id="removeme"  action="upload5.php?idcarpeta=<?php echo $_GET['nombre']; ?>&idcarpeta=<?php echo $_GET["idcarpeta"];?>&nombre2=<?php echo $nombre2; ?>" enctype="multipart/form-data"> 
        ...
        <form class="p5" value="archivos" name="otra"     method="POST" id="removeme" action="upload6.php?idcarpeta=<?php echo $_GET['nombre']; ?>&idcarpeta=<?php echo $_GET["idcarpeta"];?>&nombre2=<?php echo $nombre2; ?>" enctype="multipart/form-data">
        ...
        <form class="p6" value="archivos" name="otra"     method="POST" id="removeme" action="upload7.php?idcarpeta=<?php echo $_GET['nombre']; ?>&idcarpeta=<?php echo $_GET["idcarpeta"];?>&nombre2=<?php echo $nombre2; ?>"enctype="multipart/form-data">
        ...
        <form  class="p7"value="archivos" name="otra"     method="POST" id="removeme" action="upload8.php?idcarpeta=<?php echo $_GET['nombre']; ?>&idcarpeta=<?php echo $_GET["idcarpeta"];?>&nombre2=<?php echo $nombre2; ?>"enctype="multipart/form-data">
          <label for="" class="lb6">Carta Huerta</label>    
        ...
        <form name="form1" value="archivos" name="otra"     method="POST" id="removeme" action="upload9.php?idcarpeta=<?php echo $_GET['nombre']; ?>&idcarpeta=<?php echo $_GET["idcarpeta"];?>&nombre2=<?php echo $nombre2; ?>"  enctype="multipart/form-data" class="p8">
  ...
  $nombre2=$_GET['nombre2'];
?>
        <button onclick="location.href='finalizar.php?idcarpeta=<?php echo $_GET['idcarpeta']; ?>&nombre2=<?php echo $nombre2; ?>'" class="Blog1">FINZALIZAR</button>
