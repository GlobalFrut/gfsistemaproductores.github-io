...
$path = 'Documentos/'.$_GET['idcarpeta'].'/Acta_Constitutiva.pdf';
...
echo $directorio;
$subir_archivo = $directorio.basename($_FILES['name'].'Acta_Constitutiva.pdf');
echo "<div>";
if (move_uploaded_file($_FILES['subir_archivo']['tmp_name'], $subir_archivo)) {
   ...
   $idcarpeta=$_GET['idcarpeta'];
    $sql="UPDATE Enviados SET Acta_consti='Enviado' WHERE Nombre_carpeta='$idcarpeta'";
