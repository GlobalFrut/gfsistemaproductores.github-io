...
$path = 'Documentos/'.$_GET['idcarpeta'].'/Opnión_Cumplimiento_.pdf';
...
echo $directorio;
$subir_archivo = $directorio.basename($_FILES['name'].'Opnión_Cumplimiento_.pdf');
echo "<div>";
if (move_uploaded_file($_FILES['subir_archivo']['tmp_name'], $subir_archivo)) {
      echo "El archivo es válido y se cargó correctamente.<br><br>";
       ...
       $idcarpeta=$_GET['idcarpeta'];
        $sql="UPDATE Enviados  SET Opinion_SAT='Enviado' WHERE Nombre_carpeta='$idcarpeta'";
