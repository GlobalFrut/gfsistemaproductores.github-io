...
$path = 'Documentos/'.$_GET['idcarpeta'].'/Caratula_estado_cuenta.pdf';
...
echo $directorio;
$subir_archivo = $directorio.basename($_FILES['name'].'Caratula_estado_cuenta.pdf');
echo "<div>";
if (move_uploaded_file($_FILES['subir_archivo']['tmp_name'], $subir_archivo)) {
      echo "El archivo es v谩lido y se carg贸 correctamente.<br><br>";
       ...
       $idcarpeta=$_GET['idcarpeta'];
        $sql="UPDATE Enviados  SET  Caratula='Enviado'  WHERE Nombre_carpeta='$idcarpeta'";
