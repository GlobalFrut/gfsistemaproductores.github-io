...
$path = 'Documentos/'.$_GET['idcarpeta'].'/Carta_Huerta.pdf';
...
echo $directorio;
$subir_archivo = $directorio.basename($_FILES['name'].'Carta_Huerta.pdf');
echo "<div>";
if (move_uploaded_file($_FILES['subir_archivo']['tmp_name'], $subir_archivo)) {
     ...
     $con=mysqli_connect('localhost', 'sistemap_Product','zsHzOBuClJV','sistemap_Product') or die('Error en la conexion servidor');
       $idcarpeta=$_GET['idcarpeta'];
        $sql="UPDATE Enviados  SET Carta_renta='Enviado' WHERE Nombre_carpeta='$idcarpeta'";
